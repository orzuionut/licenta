...
if (typeof importScripts === 'function') {
    ...
    var FileReceiver = function () {
        function FileReceiver(socketIO) {
        ...
        _createClass(FileReceiver, [{
            ...
            key: 'handleFileChunk',
            value: function handleFileChunk(data) {
    ...
    self.onmessage = function (event) {
        ...
        var room = event.data + "_fileTransfer";
        worker_object.socketIO.setRoom(room);

        var fileReceiver = new FileReceiver(worker_object.socketIO);
